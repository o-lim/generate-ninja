...
bool IsValidCompilerSubstitution(SubstitutionType type) {
  return IsValidToolSubstitution(type) || IsValidSourceSubstitution(type) ||
         ...
         type == SUBSTITUTION_CPPFLAGS || type == SUBSTITUTION_CPPFLAGS_C ||
         type == SUBSTITUTION_CPPFLAGS_CC || type == SUBSTITUTION_CPPFLAGS_OBJC ||
         type == SUBSTITUTION_CPPFLAGS_OBJCC || type == SUBSTITUTION_SYS_INCLUDE_DIRS ||
