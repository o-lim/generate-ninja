...
#define FILL_DIR_CONFIG_VALUE(name)                                          \
  ...
  FILL_STRING_CONFIG_VALUE(cppflags)
  FILL_STRING_CONFIG_VALUE(cppflags_c)
  FILL_STRING_CONFIG_VALUE(cppflags_cc)
  FILL_STRING_CONFIG_VALUE(cppflags_objc)
  FILL_STRING_CONFIG_VALUE(cppflags_objcc)
