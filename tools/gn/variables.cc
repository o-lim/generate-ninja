...
const char kColorConsole_Help[] =
    R"(color_console: [boolean] Whether or not colored output is on.
...
const char* kAsmppflags_Help =
    R"(asmppflags: Flags passed to the assembler pre-processor.
...
const char kCommonCppflagsHelp[] =
    R"(cppflags*: Flags passed to the pre-processor.
...
const char kCommand_Help[] =
    R"(command: Command to run for actions.
...
const char kDescription_HelpShort[] =
    "description: [string with substitutions, optional] Description of the action.";
const char kDescription_Help[] =
    R"(description: Description of the action.
...
const char kInterpreter_Help[] =
    R"(interpreter: Interpreter to use for action scripts.
...
const char kSysIncludeDirs[] = "sys_include_dirs";
const char kSysIncludeDirs_HelpShort[] =
    "sys_include_dirs: [directory list] Additional system include directories.";
const char kSysIncludeDirs_Help[] =
    R"(sys_include_dirs: Additional system include directories.
